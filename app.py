...
if radar_theme == "Dark":
    ...
    TICK_COLOR  = "#e5e7eb"
    MINUTES_CLR = "#f5f5f5"
    MEDIAN_LINE_COLOR = "#737373"   # high contrast in dark
else:
    PAGE_BG = "#ffffff"
    AX_BG   = "#ebebeb"
    ...
    TICK_COLOR  = "#6b7280"
    MINUTES_CLR = "#374151"
    MEDIAN_LINE_COLOR = "#a3a3a3"   # high contrast in light
                    ...
                    if pool.empty:
                        ...
                        def draw_radar(labels, A_r, B_r, ticks, headerA, subA, headerB, subB, AVG_r=None):
                            ...
                            if AVG_r is not None:
                                ...
                                ax.plot(theta_c, Avg, lw=1.3, color=MEDIAN_LINE_COLOR, ls="--", alpha=1.0, zorder=4)
