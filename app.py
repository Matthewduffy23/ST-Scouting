...
if radar_theme == "Dark":
    ...
    # lighter on the OUTSIDE, alternating toward center
    ...
    GRID_BAND_OUTER = "#ffffff" # alternating subtle rings
    GRID_BAND_INNER = "#e5e7eb"
    RING_COLOR  = "#d1d5db"
    LABEL_COLOR = "#0f172a"
    TICK_COLOR  = "#6b7280"
    MINUTES_CLR = "#374151"
                    ...
                    if pool.empty:
                        ...
                        def draw_radar(labels, A_r, B_r, ticks, headerA, subA, headerB, subB):
                            ...
                            for i in range(10):
                                ...
                                # make OUTERMOST band lighter; alternate toward center
                        ...
                        st.caption(
                            ...
                            "Polygons show player percentiles vs the **combined A∪B league pool** with your universal position filter."
                        )
